...
- 20221101-gpt2-preds:
  - ~~(erp + gpt2n + gpt2n-1) + top/bot 0.3 (true_pred_prob)~~
...
- ~~20230109-gpt2-preds-top5~~: (gpt2n + gpt2n-1) + correct/incorrect (rank 5)
...
- 20230127-whisper-encoder-offset: whisper-tiny.en en-only offset + ave tokens + layer 1~4 + windows 1/1~3/1~6/1~9/1~12 starting from the offset

- ~~20230130-whisper-encoder-onset~~: whisper-tiny.en en-only onset + ave tokens + layer 1~4 + windows 0.5/1/2.5/3/5 starting from the offset
